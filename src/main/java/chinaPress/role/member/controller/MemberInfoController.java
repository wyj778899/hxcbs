...
public class MemberInfoController {
	...
	public Result findPractitionerApplyInfo(Integer id, Integer courseId, Integer roleId, Integer roleType) {
		PractitionerApplyInfoVo model = memberInfoService.findPractitionerApplyInfo(id, courseId, roleId, roleType);
		if (model != null) {
...
//		}
	...
	public Result queryPractitionerAll(String name, String certificateNumber, String tellPhone, Integer type,
	...
	public Result queryInstitutionAll(String name, String code, String legalPerson, String registerTell, Integer page,
			Integer limit) {
	...
	@ResponseBody
	public Result dataImport(MultipartFile file, HttpServletRequest request, HttpServletResponse response,
			Integer type) {
		Result result = null;
		if (file == null) {
