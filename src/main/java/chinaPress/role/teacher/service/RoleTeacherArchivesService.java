...
public class RoleTeacherArchivesService {
	...
	public List<TeacherCertificateVo> selectTeacherCertificate(String name, String idCard, Integer type,
			Integer certificateType, String certificateCode) {
		List<TeacherCertificateVo> data = roleTeacherArchivesMapper.selectTeacherCertificate(name, idCard, type,
