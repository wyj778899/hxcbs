package chinaPress.common.sms.conf;
...
public class SMSConfig {
	...
	private String sn = "SDK-WSS-010-12472";// 序列号
	private String password = "BCbQzg2H";
	 ...
	 * 构造函数175259202
	 */
	public SMSConfig(String sn, String password) throws UnsupportedEncodingException {
		this.sn = sn;
