...
public class HttpClient {
	 ...
	 * @throws Exception
	 */
	public static Result doGet(String url, Map<String, String> params) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static Result doGet(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
		// 创建httpClient对象
	 ...
	 * @throws Exception
	 */
	public static Result doPost(String url, Map<String, String> params) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static Result doPost(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
		// 创建httpClient对象
		CloseableHttpClient httpClient = HttpClients.createDefault();
	 ...
	 * @throws Exception
	 */
	public static Result doPut(String url, Map<String, String> params) throws Exception {
		CloseableHttpClient httpClient = HttpClients.createDefault();
	 ...
	 * @throws Exception
	 */
	public static Result doDelete(String url, Map<String, String> params) throws Exception {
		if (params == null) {
	 ...
	 * @throws Exception
	 */
	public static Result getResult(CloseableHttpResponse httpResponse, CloseableHttpClient httpClient,
