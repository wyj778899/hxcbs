...
public class SSH2Util {
	...
	public void putFile(String localPath, String localFile, String remotePath) throws Exception {
		...
		c.put(file, remoteFile, new MyProgressMonitor(100l));
		c.quit();
	...
	public static void main(String[] args) throws Exception {
		SSH2Util ssh2Util = new SSH2Util("47.92.92.236", "root", "Huaxiachubanshe123", 22);
//		ssh2Util.putFile("D:\\e+cloud", "m601.mp4", "/home/");
		ssh2Util.putFile("D:\\linux\\安装包", "CentOS-7-x86_64-DVD-1810.iso", "/home/");
	}
